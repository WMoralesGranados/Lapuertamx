...
@Component({
  selector: 'app-milan-tres-modulos',
  templateUrl: './milan-tres-modulos.component.html',
  styleUrl: './milan-tres-modulos.component.css'
})
export class MilanTresModulosComponent {
