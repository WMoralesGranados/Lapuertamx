...
@Component({
  selector: 'app-fc-cajonera-costado',
  templateUrl: './fc-cajonera-costado.component.html',
  styleUrl: './fc-cajonera-costado.component.css'
})
export class FCCajoneraCostadoComponent {
...
ajustarPoste(tipo: 'izq' | 'der', cambio: number) {
  ...
  calcularAnchoPuerta() {
    if (this.ancho !== null && this.ancho > 0) {
      const resultadoAnchoPuerta = (this.ancho - 600 - 30 - this.posteDerecho) / 2 + 10;
